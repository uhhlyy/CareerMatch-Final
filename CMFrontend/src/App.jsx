...
function AppContent() {
  ...
  const hideNavbarRoutes = ['/roleselection', '/SeekerMainPage', '/ResumeBuilder', '/CompanyMainPage', '/JobPosting', '/Seeker_ApplicationTracker', '/EmployerReview','/SeekerProfile', '/AdminDashboard'];
